    ...
    try:
        ...
        if next_appointment:
            ...
            next_appointment_data = {
                ...
                # --- CORRECTED LINE ---
                "dateTime": next_appointment.appointment_datetime.isoformat() + "Z" # Append 'Z' for UTC
                # --- END OF CORRECTION ---
            }
        # --- THIS IS THE CORRECTED LOGIC ---
        # The old code only counted prescriptions from online appointments.
        # This new code correctly counts all health records of the 'prescription' type.
